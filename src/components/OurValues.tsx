...
const OurValues: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Values Section - Fits in viewport */}
      <div className="min-h-screen flex items-center py-12">
        <div className="container mx-auto px-4 md:px-6 relative">
          ...
          <div className="text-center mb-12">
            ...
            <p className={`text-lg md:text-xl text-gray-700 leading-relaxed max-w-2xl mx-auto transition-all duration-700 delay-200 ${
              sectionVisible ? 'opacity-100 transform-none' : 'opacity-0 translate-y-10'
            }`}>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-12">
            {values.map((value, index) => (
              ...
              >
                <div className={`relative bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-primary-200 transition-all duration-500 ${
          ...
          {/* Vision Breakdown Section - Compact */}
          <div className={`transition-all duration-1000 delay-700 ${
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {visionPoints.map((point, index) => (
                ...
                >
                  <div className="bg-white/60 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-primary-200 transition-all duration-300 hover:shadow-xl hover:scale-105">
                    <div className="w-12 h-12 bg-gradient-to-r from-primary-500 to-primary-600 text-white rounded-full flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform duration-300">
                      {point.icon}
                    </div>
                    <h4 className="font-bold text-lg text-gray-800 mb-2 group-hover:text-primary-600 transition-colors duration-300">
                      {point.title}
                    </h4>
      ...
      {/* Ethical Standards Section - Appears after scroll */}
      <div className="py-20">
        <div className="container mx-auto px-4 md:px-6 relative">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {ethicalPractices.map((practice, index) => (
              ...
              >
                ...
                <p className="text-gray-700 leading-relaxed text-sm">{practice.description}</p>
          ...
          <div className="text-center">
            <div className="bg-gradient-to-r from-primary-50 to-primary-100 rounded-3xl p-8 border border-primary-200">
              <h3 className="text-2xl md:text-3xl font-serif font-bold text-gray-800 mb-3">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  href="#visit-us"
                  className="inline-flex items-center gap-3 px-6 py-3 bg-white border-2 border-primary-600 text-primary-700 font-semibold rounded-full hover:bg-primary-600 hover:text-white transition-all duration-300 transform hover:scale-105"
                >
