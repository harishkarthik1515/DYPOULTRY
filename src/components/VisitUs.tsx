    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className={`text-lg text-white/80 transition-all duration-700 delay-100 ${
            sectionVisible ? 'opacity-100 transform-none' : 'opacity-0 translate-y-10'
          }`}>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div className={`transition-all duration-1000 ${
            ...
            <div className="bg-primary-700 rounded-lg p-8 shadow-lg">
              ...
              <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  <div>
                    ...
                    <input
                      ...
                      name="name"
                      required
                      className="w-full px-4 py-2 bg-primary-500 border border-primary-400 rounded-md focus:outline-none focus:ring-2 focus:ring-white/50 text-white placeholder-primary-300"
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-center">
                    <Calendar size={20} className="text-white/80 mr-2" />
                    <input
                      type="date"
                      id="date"
                      name="date"
                      required
                      className="w-full px-4 py-2 bg-primary-500 border border-primary-400 rounded-md focus:outline-none focus:ring-2 focus:ring-white/50 text-white"
                    />
                  </div>
                </div>
                
                <div className="mb-4">
                  <label htmlFor="groupSize" className="block text-sm font-medium text-white/80 mb-1">
                    Number of Visitors
                  </label>
                  <select
                    id="groupSize"
                ...
                <button
                  type="submit"
                  className="w-full px-6 py-3 bg-white text-primary-600 font-medium rounded-md transition-all duration-300 hover:bg-primary-50 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-white/50"
                >
                  Request Tour
                </button>
              </form>
          ...
          <div className={`transition-all duration-1000 ${
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="bg-primary-700/50 rounded-lg p-6 shadow-lg">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <p className="text-white/90 mb-1"><strong>Farm Store Hours:</strong></p>
                        <p className="text-white/90">Monday - Friday: 9am - 5pm</p>
                        <p className="text-white/90">Saturday: 9am - 3pm</p>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <p className="text-white/90 mb-1"><strong>Farm Tours:</strong></p>
                        <p className="text-white/90">Available Wednesday - Saturday</p>
