        ...
        <div className="max-w-4xl mx-auto text-center mb-20">
          <div className={`mb-6 transition-all duration-700 ${
            ...
            <div className="inline-flex items-center gap-4 mb-4">
              ...
              <span className="text-primary-600 font-semibold tracking-widest uppercase text-sm">Our Journey</span>
              <div className="w-12 h-0.5 bg-gradient-to-r from-transparent via-primary-600 to-transparent"></div>
            </div>
          </div>
                  ...
                  >
                    ...
                    <div className={`ml-14 group cursor-pointer transition-all duration-300 ${
                      ...
                      <div className={`bg-white rounded-xl p-6 shadow-lg border border-gray-100 transition-all duration-300 ${
                        ...
                        <h3 className="font-bold text-gray-800 text-xl mb-2 group-hover:text-primary-600 transition-colors duration-300">
                          {event.title}
                        </h3>
