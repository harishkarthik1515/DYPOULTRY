      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-12">
          {[
            ...
            >
              <h3 className="text-xl font-bold text-primary-700 mb-2">{fact.title}</h3>
              <p className="text-primary-700">{fact.description}</p>
            </div>
          ))}
        </div>
        ...
        <div className={`mt-12 text-center transition-all duration-700 delay-900 ${
          ...
          <a
            href="#visit-us"
            className="inline-block px-8 py-3 bg-primary-600 text-white font-medium rounded-full transition-all duration-300 hover:bg-primary-700 transform hover:scale-105 shadow-md hover:shadow-lg"
          >
            Book a Farm Tour
          </a>
        </div>
